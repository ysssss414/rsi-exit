...
class WarningEndReason(str, Enum):
    FORMAL_DIVERGENCE_CONFIRMED = "FORMAL_DIVERGENCE_CONFIRMED"
    MOMENTUM_ANCHOR_REBUILT = "MOMENTUM_ANCHOR_REBUILT"
    DEEP_RSI_RESET_COMPLETED = "DEEP_RSI_RESET_COMPLETED"
    CONFIRMED_WITHOUT_FORMAL_DIVERGENCE = (
        "CONFIRMED_WITHOUT_FORMAL_DIVERGENCE"
    )
    INTRADAY_RETEST_ONLY = "INTRADAY_RETEST_ONLY"
    NON_COMPARABLE_CONFIRMATION = "NON_COMPARABLE_CONFIRMATION"
    FORMING_CONDITION_BROKEN = "FORMING_CONDITION_BROKEN"
